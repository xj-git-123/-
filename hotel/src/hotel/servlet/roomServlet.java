...
//            }
    ...
    private void Add(HttpServletRequest request, HttpServletResponse response) throws IOException{
        try {
            ...
            String reviewdata = request.getParameter("reviewdata");
            String reviewcontent = request.getParameter("reviewcontent");
            String reviewimage = request.getParameter("reviewimage");
            String nickname = request.getParameter("nickname");


            String sql = "insert into room(reviewno,title,reviewdata,reviewcontent,reviewimage,nickname) values(?,?,?,?,?,?)";
            if (DBUtils.Update(sql, reviewno,title,reviewdata,reviewcontent,reviewimage,nickname) > 0) {
    ...
    private void Update(HttpServletRequest request, HttpServletResponse response) throws IOException{
        try {
            ...
            String sql = "update bookReview set title= ? ,reviewdata= ?,reviewcontent= ?,reviewimage= ?,nickname= ? where reviewno= ? ";
            if (DBUtils.Update(sql,title,reviewdata,reviewcontent,reviewimage,nickname, reviewno) > 0) {
