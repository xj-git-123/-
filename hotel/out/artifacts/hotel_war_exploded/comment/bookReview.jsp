    ...
    $(function () {
        ...
        $('#btnAdd').click(function () {
            $('#dd').dialog({
                ...
                closed: false,
                cache: false,
                href: 'bookReviewForm.jsp?action=add&r=' + Math.random(),
                modal: true,
                buttons: [{
                    text: '保存',
                    iconCls: 'icon-save',
            ...
            $.messager.confirm('确认', '是否确认删除', function (r) {
                if (r) {
                    ...
                    $.ajax(
                        {
                            type: "get",
                            url: '/roomInfoServlet?action=delete',
        ...
        function saveData(action) {
            $.messager.progress();
            $('#ff').form('submit', {
                url: '/roomInfoServlet?action=' + action,
                onSubmit: function () {
        ...
        function loadData(val) {
            $('#dg').datagrid({
                fitColumns:true,
                url: '/roomInfoServlet?action=getslist',
                toolbar: '#tb',
                height:'100%',
                ...
                columns: [[
                    {field: 'reviewno', title: '书评编号', width: 100},
                    {field: 'title', title: '标题', width: 100},
                    {field: 'reviewcontent', title: '内容', width: 100},
                    {field: 'reviewimage', title: '图片', width: 100},
                    {field: 'nickname', title: '昵称', width: 100},
                    {field: 'reviewdate', title: '发布日期', width: 100},
        ...
        <tr>
            ...
            <td>
                <input class="easyui-textbox" id="btnQuery"
                       data-options="buttonText:'搜索',buttonIcon:'icon-search',prompt:'根据书评号搜索'"
