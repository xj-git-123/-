    ...
    $(function () {
        ...
        $('#btnAdd').click(function () {
            $('#dd').dialog({
                ...
                closed: false,
                cache: false,
                href: 'bookForm.jsp?action=add&r=' + Math.random(),
                modal: true,
                buttons: [{
                    text: '保存',
                    iconCls: 'icon-save',
        ...
        $('#btnEdit').click(function () {
            ...
            $('#dd').dialog({
                ...
                closed: false,
                cache: false,
                href: 'bookForm.jsp?action=edit&r=' + Math.random(),
                modal: true,
                buttons: [{
                    text: '保存',
                    iconCls: 'icon-save',
        ...
        function loadData(val) {
            $('#dg').datagrid({
                fitColumns:true,
                url: '/bookServlet?action=getslist',
                toolbar: '#tb',
                height:'100%',
                ...
                columns: [[
                    {field: 'bookno', title: '图书编号', width: 100},
                    {field: 'bookname', title: '图书名称', width: 100},
                    {field: 'writer', title: '作者', width: 100},
                    {field: 'location', title: '图书位置', width: 100},
                    {field: 'remain', title: '剩余数量', width: 100},
                    {field: 'borrownumber', title: '借阅数量', width: 100},
        ...
        <tr>
            ...
            <td>
                <input class="easyui-textbox" id="btnQuery"
                       data-options="buttonText:'搜索',buttonIcon:'icon-search',prompt:'根据图书编号搜索'"
