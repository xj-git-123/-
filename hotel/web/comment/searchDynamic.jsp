...
<script>
    $(function () {
        ...
        function loadData(val) {
            $('#dg').datagrid({
                fitColumns: true,
                url: '/openServlet?action=getslist',
                toolbar: '#tb',
                height: '100%',
                pagination: true,
                fit: true,
                ...
                columns: [[
                    {field: 'searchno', title: '寻贴编号', width: 100},
                    {field: 'nickname', title: '昵称', width: 100},
                    {field: 'searchcontent', title: '内容', width: 100},
                    {field: 'searchimage', title: '图片', width: 100},
                    {field: 'searchdate', title: '发布日期', width: 100},
                    {
